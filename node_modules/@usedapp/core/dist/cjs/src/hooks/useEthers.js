...
function useEthers() {
    var _this = this;
    var _a = providers_1.useNetwork(), _b = _a.network, provider = _b.provider, chainId = _b.chainId, accounts = _b.accounts, errors = _b.errors, deactivate = _a.deactivate, activate = _a.activate;
    var _c = providers_1.useInjectedNetwork(), injectedProvider = _c.injectedProvider, connect = _c.connect;
    var _d = useLocalStorage_1.useLocalStorage('shouldConnectMetamask'), setShouldConnectMetamask = _d[1];
    var result = {
        connector: undefined,
        library: provider,
        chainId: chainId,
    ...
    var activateBrowserWallet = react_1.useCallback(function () { return __awaiter(_this, void 0, void 0, function () {
