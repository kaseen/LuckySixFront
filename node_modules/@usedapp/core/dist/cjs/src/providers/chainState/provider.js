...
function ChainStateProvider(_a) {
    ...
    var multicallVersion = config_1.useConfig().multicallVersion;
    var multicall = multicallVersion === 1 ? multicall_1.multicall : multicall2_1.multicall2;
    var _b = hooks_1.useEthers(), library = _b.library, chainId = _b.chainId;
    var blockNumber = context_1.useBlockNumber();
    var reportError = providers_1.useNetwork().reportError;
    ...
    var uniqueCalls = debouncedId === chainId ? helpers_1.getUniqueCalls(debouncedCalls) : [];
